				    ...
				    <div class="col-md-6 offset-md-3">
				      <div class>
				        <ul class="d-flex flex-wrap justify-content-between mb-4">
				          <li>라떼시네마 상영관을 대관하여 원하는 날짜에 원하는 영화를 프라이빗하게 관람할 수 있는 서비스입니다.</li>
				          <li>단체관람은 신청일 기준 라떼시네마에서 현재 상영중인 영화 및 단체 관람 희망일 기준 개봉 예정작인 영화 관람에 한해 신청 가능합니다.</li>
				          <li>단체관람은 신청일 기준 최소 10일 이후의 일정으로 신청해주셔야 가능합니다.</li>
				          <li>그 외 다른 영화 관람을 원하시는 경우에는 우선 라이카시네마 담당자에게 문의주시거나, 해당 영화 배급사에 관람 가능 여부 확인 후 신청서를 작성해주세요.</li>
				          <li>행사 내용 등을 상세히 남겨 주시면 더욱 정확한 답변과 견적 산출이 가능합니다.</li>
				        </ul>
				      </div>
				    </div>
				  </div>
				...
				<div class="row justify-content-center">
			      <div class="col-lg-4 col-md-8 col-sm-10">
			        ...
			        <form action="#">
			          ...
			          <div class="form-group mb-3">
			            <label for="wish_movie">관람할 영화</label>
			            <input type="text" class="form-control" id="wish_movie" placeholder="관람할 영화 입력">
			          </div>
			          <div class="form-group mb-3">
			            <label for="wish_date">관람 희망 일시</label>
			            <input type="text" class="form-control" id="wish_date" placeholder="관람 희망 일시 입력">
			          </div>
			          <div class="form-group mb-3">
			            <label for="audienceNum">관람 인원</label>
			            <input type="text" class="form-control" id="audienceNum" placeholder="최대 40명까지">
			          </div>
			          <div class="form-group mb-3">
			            <label for="question">기타 문의</label>
			            <div>
			          ...
			          <div class="form-group mb-3">
			            ...
			            <div>
				            <textarea class="form-control" id="agreement" style="overflow: auto; height: 200px;">회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
...
이 개인정보 처리방침은 20XX. X. X부터 적용됩니다.</textarea>
			            </div>
			          </div>
