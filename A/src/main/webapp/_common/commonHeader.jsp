    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="store.jsp"><span>스토어</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
          ...
          <li class="dropdown"><a href="#"><span>고객지원</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="cs_member.jsp">멤버십</a></li>
              <li><a href="cs_center.jsp">고객센터</a></li>
              <li><a href="cs_rent.jsp">단체관람/대관문의</a></li>
            </ul>
          </li>
        </ul>
      </nav><!-- .navbar -->
      ...
      <div class="position-relative">
        ...
        <a href="#" class="mx-2">로그인</a>  				<!-- **로그인 세션 있으면 로그아웃으로 변경 -->
        <a href="#" class="mx-2">회원가입</a> 				<!-- **로그인 세션 있으면 마이페이지로 변경 -->
