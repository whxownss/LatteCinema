					...
					<div class="swiper-wrapper">
						<div class="swiper-slide" style="height: 100%">
							<a href="#" class="img-bg d-flex align-items-end"
								style="background-image: url('assets/img/mainSlide1.jpg'); height:800px !important;">
						...
						<div class="swiper-slide">
							<a href="#" class="img-bg d-flex align-items-end"
								style="background-image: url('assets/img/mainSlide2.jpg'); height:800px !important;">
								<div class="img-bg-inner">
...
<!-- 						</div> -->
					...
					<div class="custom-swiper-button-next">
						<span class="bi-chevron-center"></span>
					</div>
