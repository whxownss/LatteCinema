											...
											<tbody id="tbody">
												<c:forEach var="sch" items="${allSchedules}">
													<tr>
														...
														<td><button  type="button" class="btn btn-primary deleteSchBtn">삭제</button></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/_assets/js/admJS/adm_cinema.js"></script>
